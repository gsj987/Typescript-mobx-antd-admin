...
@observer
class Dashboard extends React.Component<void, void>{
  @inject('DashboardStore')
  private dashboard: IDashboardStore

  render() {
    const { weather, sales, quote, numbers, recentSales, comments, completed, browser, cpu, user } = this.dashboard
